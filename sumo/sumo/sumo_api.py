from sumo.DeepSurvivalMachines.dsm.dsm_api import DSMBase
from sumo.sumo.sumo_torch import SuMoTorch
import sumo.sumo.losses as losses
from sumo.sumo.utilities import train_sumo
  ...
  def predict_survival(self, x, t, risk = None):
    ...
    if self.fitted:
      ...
      for t_ in t:
        ...
        outcomes = self.torch_model.predict(x.double(), t_)
